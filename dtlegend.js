...
var verbose = false;
    function DTLegend(table, sections, caller, filter_function, special_funcs) {
      ...
      if (special_funcs) {
        ...
        this.special_funcs = function (lbl) {
          ...
          var action = false;
          switch (lbl) {
            case 'lbl0': lb0 = !lb0; action = !lb0; break;
            case 'lbl1': lb1 = !lb1; action = !lb1; break;
            case 'lbl2': lb2 = !lb2; action = !lb2; break;
            case 'lbl3': lb3 = !lb3; action = !lb3; break;
            case 'lbl4': lb4 = !lb4; action = !lb4; break;
            case 'lbl5': lb5 = !lb5; action = !lb5; break;
            case 'lbl6': lb6 = !lb6; action = !lb6; break;
            case 'lbl7': lb7 = !lb7; action = !lb7; break;
            case 'lbl8': lb8 = !lb8; action = !lb8; break;
            case 'lbl9': lb9 = !lb9; action = !lb9; break;
          }
    ...
    DTLegend.prototype.filter = function (idx) {
      var lbl = "lbl" + idx;
